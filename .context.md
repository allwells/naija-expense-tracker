...
- [x] **Phase 1**: Scaffold, auth, theme, PWA, shell pages
- [x] **Phase 2**: Database schema, types, service layer
- [x] **Phase 3**: Expense logging UI + OCR receipt scanning
- [x] **Phase 4**: Income tracking UI
- [x] **Phase 5**: Nigeria 2026 Tax Engine (critical — unit tested)
- [x] **Phase 6**: Dashboard + Reports with live tax numbers
- [x] **Phase 7**: CSV export + audit package
- [x] **Phase 8**: Settings, onboarding, mobile polish
